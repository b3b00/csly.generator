...
using JList = jsonbench.csly.JsonModel.JList;
using JNull = jsonbench.csly.JsonModel.JNull;
using JObject = jsonbench.csly.JsonModel.JObject;
using JSon = jsonbench.csly.JsonModel.JSon;
using JValue = jsonbench.csly.JsonModel.JValue;

namespace jsonbench.csly
{
    [BroadenTokenWindow]
    [ParserRoot("root")]
